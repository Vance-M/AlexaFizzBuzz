...
const handlers = {
   ...
   'SessionEndedRequest': function () {
	...
	'PlayFizzBuzzIntent': function () {
		speechOutput = '';

		//any intent slot variables are listed here for convenience

		let gameNameSlotRaw = this.event.request.intent.slots.gameName.value;
		console.log(gameNameSlotRaw);
		let gameNameSlot = resolveCanonical(this.event.request.intent.slots.gameName);
		console.log(gameNameSlot);

		//Your custom intent handling goes here
		speechOutput = "This is a place holder response for the intent named PlayFizzBuzzIntent. This intent has one slot, which is gameName. Anything else?";
		this.emit(":ask", speechOutput, speechOutput);
    },	
	'Unhandled': function () {
